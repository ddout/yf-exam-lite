...
public class UserWrongBookController extends BaseController {
    ...
    @Autowired
    private UserWrongBookService baseService;
    ...
    */
    ...
    public ApiRest<IPage<UserWrongBookDTO>> paging(@RequestBody PagingReqDTO<UserWrongBookDTO> reqDTO) {

        //分页查询并转换
        IPage<UserWrongBookDTO> page = baseService.paging(reqDTO);
    ...
    public ApiRest<BaseIdRespDTO> nextQu(@RequestBody BaseIdReqDTO reqDTO) {
        //转换并返回
        String quId = baseService.findNext(reqDTO.getUserId(), reqDTO.getId());
